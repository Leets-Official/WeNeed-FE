...
const mockPortfolioDetails = {
  user: {
    nickname: '위니드',
    sameUser: false, //글쓴 사람 != 현재 보고있는 나
  },
  portfolio: {
    thumbnail:
    ...
    contents: [
      {
        ...
        type: 'text',
        textData:
          '에스파의 패키지 디자인은 화려하고 현대적인 분위기를 담고 있습니다. 디자인의 주요 컨셉은 미래 도시입니다. 패키지의 전체적인 색상은 신비로운 보라색과 러블리한 핑크색으로 구성되어 있으며, 이를 통해 팬들에게 환상적이고 사랑스러운 느낌을 전달합니다. 패키지의 중심에는 에스파의 로고가 크게 배치되어 있으며, 로고 주변에는 퓨처리스틱한 도시의 모습이 그려져 있습니다. 패키지의 가장자리에는 첨단 기술의 흐름을 상징하는 라인 패턴이 있어, 전체적인 디자인에 동적인 느낌을 더해줍니다. 또한, 패키지의 여러 모서리에는 삼각형 형태의 조명이 배치되어 있어, 공간감과 깊이감을 부여하여 패키지의 시각적인 효과를 높였습니다. 이러한 디자인은 에스파의 음악과 컨셉을 잘 반영하며, 팬들에게 독특하고 매력적인 경험을 선사할 것입니다.',
      },
      {
        id: 2,
        type: 'image',
